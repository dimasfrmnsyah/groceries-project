...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('purchase.store') }}" method="POST">
            ...
            <p class="text-muted small">Gunakan scanner/ketik <strong>product_code</strong> di kotak pencarian Select2. Tekan <strong>Enter</strong> atau tombol Tambah untuk memasukkan produk ke daftar.</p>
